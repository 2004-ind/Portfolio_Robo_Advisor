...
def validate_data(age, dollars, intent_request):
    ...
    if age is not None:
        age = parse_int(age) #datetime.strptime(age, "%Y-%m-%d")
        #age = relativedelta(datetime.now(), age).years
        if age < 0 :
            return build_validation_result(
                False,
                "birthday",
                "You should be more than 0 years old to use this service, "
    ...
    if dollars is not None:
        ...
        if dollars < 5000:
            return build_validation_result(
                False,
                "dollars",
                "The invest amount should be at least $5000, "
                "please provide a correct amount to provide best recommendation .",
            )
...
# Gets the invocation source, for Lex dialogs "DialogCodeHook" is expected.
    ...
    recomendation=get_investment_recommendation(risk_level)
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            "content": """Thank you for your information.For you the best recommendation would be ;{}
